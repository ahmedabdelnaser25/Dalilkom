...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      this.isWaitingRequest = true;
      this.$axios.defaults.headers.common["Authorization"] = "Bearer " + localStorage.getItem("dalilkum_admin_dashboard_forget_pass_token");
      ...
      try {
        ...
        localStorage.removeItem("dalilkum_admin_dashboard_forget_pass_token");
