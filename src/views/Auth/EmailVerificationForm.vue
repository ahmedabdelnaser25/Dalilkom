  ...
  methods: {
    ...
    async resendVerificationCode() {
      ...
      this.$axios.defaults.headers.common["Authorization"] =
        "Bearer " +
        localStorage.getItem("dalilkum_admin_dashboard_forget_pass_token");
      ...
      try {
        ...
        localStorage.setItem(
          "dalilkum_admin_dashboard_verification_code",
          res.data.body.code
        );
    ...
    async submitForm() {
      ...
      if (this.verificationType == "reset-password") {
        try {
          ...
          this.clearFormInputs();
          localStorage.removeItem("dalilkum_admin_dashboard_email");
