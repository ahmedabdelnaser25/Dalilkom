...
// Global headers
axios.defaults.baseURL = "https://backend.dalilkum-sa.com/dashboard-api/v1/";
...
axios.interceptors.request.use(
  ...
  function (error) {
    ...
    if (error.response.status === 401) {
      localStorage.removeItem("dalilkum_admin_dashboard_user_id");
      localStorage.removeItem("dalilkum_admin_dashboard_user_token");
      localStorage.removeItem("dalilkum_admin_dashboard_userName");
      router.replace("/");
    }
